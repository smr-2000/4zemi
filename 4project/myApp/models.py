...
class hobby(models.Model):
   ...
   hobby1=models.CharField(max_length=20, choices=[('スポーツ','スポーツ'),('読書','読書'),('旅行','旅行'),('カメラ','カメラ'),('ドラマ・映画鑑賞','ドラマ・映画鑑賞'),('ジャニーズ','ジャニーズ'),('アニメ','アニメ'),('漫画','漫画'),('料理','料理'),('お笑い','お笑い'),('K-POP','K-POP'),('ドライブ','ドライブ'),('ゲーム','ゲーム')])
   
   hobby2=models.CharField(max_length=20, choices=[('スポーツ','スポーツ'),('読書','読書'),('旅行','旅行'),('カメラ','カメラ'),('ドラマ・映画鑑賞','ドラマ・映画鑑賞'),('ジャニーズ','ジャニーズ'),('アニメ','アニメ'),('漫画','漫画'),('料理','料理'),('お笑い','お笑い'),('K-POP','K-POP'),('ドライブ','ドライブ'),('ゲーム','ゲーム')], null=True, blank=True)
                           
   hobby3=models.CharField(max_length=20, choices=[('スポーツ','スポーツ'),('読書','読書'),('旅行','旅行'),('カメラ','カメラ'),('ドラマ・映画鑑賞','ドラマ・映画鑑賞'),('ジャニーズ','ジャニーズ'),('アニメ','アニメ'),('漫画','漫画'),('料理','料理'),('お笑い','お笑い'),('K-POP','K-POP'),('ドライブ','ドライブ'),('ゲーム','ゲーム')], null=True, blank=True)
